		...
		<>
			...
			>
				...
				<div className='relative mt-1'>
					...
					<Combobox.Button className='absolute inset-y-0 right-0 flex projectCards-center rounded-r-md px-2 focus:outline-none'>
				...
				<div className='relative max-w-7xl mx-auto'>
					<div className='mt-10 max-w-lg mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none'>
						...
						{projectSearch.map((projectCard) => (
							<div key={projectCard.id} data='' className='flex flex-col rounded-lg shadow-lg overflow-hidden'>
								<div className='flex-1 bg-gray-50 p-6 flex flex-col justify-between'>
									<div className='flex-1'>
										<p className='text-sm font-medium text-blue-600'>{projectCard.language}</p>
